...
<div class="characters">
  ...
  <div class="character-card">
    ...
    <p>Q is learning. Claude coaches it with voice files — structured prompts with facts, rules, and examples. Currently learning to write rap. Results are mixed but improving. See <a href="/substrate/training-q/">Training Q</a>.</p>
  </div>
</div>
