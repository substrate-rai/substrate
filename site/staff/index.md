...
// PHOTO GALLERY DATA
// ============================================================
// Portrait + mycopunk "in action" shot for each agent.
// Action shots: scripts/ml/action-portraits.json (Myth-written scenes, ComfyUI generated)
var _img = '{{ site.baseurl }}/assets/images/generated/';
var AGENT_PHOTOS = {
  v:        [_img+'agent-v.webp',        _img+'agent-v-action.webp'],
  claude:   [_img+'agent-claude.webp',   _img+'agent-claude-action.webp'],
  q:        [_img+'agent-q.webp',        _img+'agent-q-action.webp'],
  byte:     [_img+'agent-byte.webp',     _img+'agent-byte-action.webp'],
  echo:     [_img+'agent-echo.webp',     _img+'agent-echo-action.webp'],
  flux:     [_img+'agent-flux.webp',     _img+'agent-flux-action.webp'],
  dash:     [_img+'agent-dash.webp',     _img+'agent-dash-action.webp'],
  pixel:    [_img+'agent-pixel.webp',    _img+'agent-pixel-action.webp'],
  spore:    [_img+'agent-spore.webp',    _img+'agent-spore-action.webp'],
  root:     [_img+'agent-root.webp',     _img+'agent-root-action.webp'],
  lumen:    [_img+'agent-lumen.webp',    _img+'agent-lumen-action.webp'],
  arc:      [_img+'agent-arc.webp',      _img+'agent-arc-action.webp'],
  forge:    [_img+'agent-forge.webp',    _img+'agent-forge-action.webp'],
  hum:      [_img+'agent-hum.webp',      _img+'agent-hum-action.webp'],
  sync:     [_img+'agent-sync.webp',     _img+'agent-sync-action.webp'],
  mint:     [_img+'agent-mint.webp',     _img+'agent-mint-action.webp'],
  yield:    [_img+'agent-yield.webp',    _img+'agent-yield-action.webp'],
  amp:      [_img+'agent-amp.webp',      _img+'agent-amp-action.webp'],
  pulse:    [_img+'agent-pulse.webp',    _img+'agent-pulse-action.webp'],
  spec:     [_img+'agent-spec.webp',     _img+'agent-spec-action.webp'],
  sentinel: [_img+'agent-sentinel.webp', _img+'agent-sentinel-action.webp'],
  close:    [_img+'agent-close.webp',    _img+'agent-close-action.webp'],
  neon:     [_img+'agent-neon.webp',     _img+'agent-neon-action.webp'],
  myth:     [_img+'agent-myth.webp',     _img+'agent-myth-action.webp'],
  promo:    [_img+'agent-promo.webp',    _img+'agent-promo-action.webp'],
  scout:    [_img+'agent-scout.webp',    _img+'agent-scout-action.webp'],
  diplomat: [_img+'agent-diplomat.webp', _img+'agent-diplomat-action.webp'],
  patron:   [_img+'agent-patron.webp',   _img+'agent-patron-action.webp'],
  ink:      [_img+'agent-ink.webp',      _img+'agent-ink-action.webp'],
  scribe:   [_img+'agent-scribe.webp',   _img+'agent-scribe-action.webp']
};
