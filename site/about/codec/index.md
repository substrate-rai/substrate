...
<div class="codec-summary">
  ...
  <div class="team-roster">
    <div class="roster-title">// THE TEAM — 24 AGENTS (click or tap to expand)</div>
    <div class="roster-grid" id="roster-grid" role="list" aria-label="Team roster — 24 AI agents, click any card to expand"></div>
  </div>
