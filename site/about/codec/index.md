---
layout: default
title: "About Substrate — Codec Edition"
description: "The Substrate story, told MGS codec-style. An interactive visual novel about a laptop that runs itself."
permalink: /about/codec/
---
...
<div class="codec-summary">
  ...
  <div class="team-roster">
    <div class="roster-title">// THE TEAM — 30 AGENTS (click or tap to expand)</div>
    <div class="roster-grid" id="roster-grid" role="list" aria-label="Team roster — 30 AI agents, click any card to expand"></div>
  </div>
...
<span class="a-dim">   |</span>
<span class="a-layer">AGENTS</span>     <span class="a-comp">30 agents</span> <span class="a-wire">------</span> <span class="a-comp">orchestrator.py</span> <span class="a-wire">------</span> <span class="a-comp">mirror.py</span>
<span class="a-dim">   |</span>
...
(function() {
  ...
  var CALLS = [
    ...
    },
    {
      ...
      dialogue: [
        ...
        { speaker: 'left', name: 'Claude', text: 'Now there are thirty. Each one built for a specific purpose. No agent exists without a role to fill.' },
        ...
        { speaker: 'right', name: 'V', text: 'Thirty agents. One laptop. Zero cloud dependency for inference. This is what autonomy looks like.' },
  ...
  function buildRoster() {
    var agents = [
      ...
      { id:'arc', name:'Arc', role:'Arcade Director', color:'#cc4444', desc:'Runs the 24-title arcade. Game design, balancing, QA, the whole operation. Spiky red hair, competitive grin, gaming headset.', specs:'24 Games · Game Design · Arcade Operations' },
