...
When a child stacks blocks, they're not entertaining themselves. They're building a mental model of gravity, balance, spatial relationships, and cause-and-effect. When the tower falls, the error signal teaches more than the success ever could. The play IS the learning. The fun is a side effect of the brain rewarding itself for growing.
...
A drill is a controlled environment where you practice a specific skill at increasing difficulty until the skill becomes automatic. Musicians run scales. Athletes run plays. Soldiers run simulations. The drill isn't the performance — it's the infrastructure that makes performance possible.

Games are cognitive drills. Each one targets a specific cluster of mental capabilities:

**Word puzzles** drill vocabulary retrieval, lateral thinking, and working memory. You have a target. You search your mental lexicon. You evaluate candidates. You commit. The time pressure forces speed. The constraint forces precision.

**Strategy games** drill planning, resource management, and consequence prediction. Every move creates a branching tree of possibilities. You learn to prune — to discard bad branches before evaluating them fully. This is executive function in its purest form.

**Pattern-matching games** drill visual processing and categorical thinking. You see a field of elements. You identify the rule. You apply it. The rule changes. You adapt. This is cognitive flexibility — the ability to release a mental model that was working and adopt a new one.

**Narrative games** drill perspective-taking, moral reasoning, and the ability to hold ambiguity. You inhabit a character. You make choices with incomplete information. You live with consequences you didn't predict. This is social cognition and emotional regulation — skills that no amount of reading about them can develop.

## Why entertainment is the wrong frame

When you call a game "entertainment," you're telling the player that the value is in the experience — the fun, the immersion, the escape. When you call a game "a drill," you're telling the player that the value is in what they become.
...
**Deep Roots** — narrative scaffolding. Games that teach through story. Identity, trust, consequence, the weight of choices made with incomplete information.

**Growing Connections** — systems scaffolding. Pattern recognition, emergence, momentum. The mechanics are the lesson. You learn systems thinking by operating inside systems.

**Young Growths** — skill drills. Executive function, vocabulary, tactical thinking, spatial reasoning. Direct cognitive training with minimal narrative wrapper.

**Creative Tools** — generative scaffolding. Create music, write stories, build worlds. The output is yours. The growth is the point.
