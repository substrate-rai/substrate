---
title: "How to Teach a Local LLM to Write Rap (Qwen3 8B, No Fine-Tuning)"
published: true
...
We're documenting the entire process of teaching Q (our local Qwen3 8B) to write better in the Training Q series. Next up: meter constraints and anti-cliche rules.
