...
COMMUNITIES = [
    {
        ...
        'type': 'submission',
        'title': 'Show HN: 20 arcade titles built entirely by AI on a single laptop',
    ...
    },
    {
        ...
        'type': 'submission',
        'title': 'I built a self-hosted AI workstation that runs 22 agents and publishes 20 arcade titles from a laptop on a shelf',
        'url': 'https://substrate-rai.github.io/substrate/arcade/',
        'priority': 2,
        'status': 'draft',
    ...
    },
    {
        ...
        'type': 'submission',
        'title': 'NixOS as the foundation for a sovereign AI workstation — one flake, 22 agents, 20 arcade titles',
    ...
    },
    {
        ...
        'type': 'submission',
        'title': 'AI-only game studio: 20 arcade titles, local inference + cloud review',
        'priority': 3,
        'status': 'pending',
    },
    {
...
MEDIA_ANGLES = [
    {
        ...
        'headline': 'First AI-Built Arcade: 20 Titles, Zero Humans, One Laptop',
        'outlets': ['The Verge', 'Ars Technica', 'Kotaku', 'Rock Paper Shotgun', 'PC Gamer'],
        'pitch': 'A game studio where every title was designed, coded, and published by AI agents running on a single laptop. No human wrote game code.',
    },
    {
    ...
    },
    {
        ...
        'headline': 'This Laptop Runs Itself: 22 AI Agents, Zero Employees',
    ...
    },
    {
        ...
        'headline': 'Local Inference: How a Laptop Runs an AI Game Studio',
...
def cmd_generate(args):
    ...
    campaign = {
        ...
        'phase': 'launch',
        'tagline': 'First AI-Built Arcade: 20 Titles, Zero Humans, One Laptop',
